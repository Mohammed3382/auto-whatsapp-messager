...
<p align="center"><sub>Windows · portable · no install · English and Arabic</sub></p>

---

## How to use

1. Download the app above and double-click it.
2. On your phone: WhatsApp → Settings → Linked Devices → Link a Device, then scan the QR code.
3. When it says Connected, paste your numbers (one per line, with country code), type your message, and click Send.
